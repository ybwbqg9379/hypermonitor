...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  hyper: {
    title: "HyperMonitor - Global Intelligence & Situation Awareness",
    description:
      "Customized global intelligence dashboard with AI-powered insights, real-time news, markets, military tracking, infrastructure monitoring, and geopolitical data.",
    keywords:
      "global intelligence, geopolitical dashboard, world news, market data, military tracking, conflict zones, real-time monitoring, situation awareness, OSINT, infrastructure monitoring, AI insights",
    url: "https://hypermonitor.vercel.app/",
    siteName: "HyperMonitor",
    shortName: "HyperMonitor",
